                            ...
                            <div className='flex flex-col gap-2.5 mt-6'>
                                <div className='border h-[47px]  rounded-[4px] flex items-center bg-[#e8ebf0] px-4 '>
                                    <div className=' flex items-center justify-between w-full '>
                                        <div className='flex items-center gap-2.5'>
                                            ...
                                            <p className='text-[15.5px]  text-[#383c43] font_Roboto_Medium flex items-center gap-2'>Day <IoChevronDownCircleOutline size={22} /></p>
                                        </div>
                                ...
                                <div className='border h-[47px]  rounded-[4px] flex items-center bg-[#e8ebf0] px-4 '>
                                    <div className=' flex items-center justify-between w-full '>
                                        <div className='flex items-center gap-2.5'>
                                            <FiMenu size={24} className='text-[#d2d7df]' />
                                            <p className='text-[15.5px]  text-[#383c43] font_Roboto_Medium flex items-center gap-2'>Hour  <IoChevronDownCircleOutline size={22} /></p>
                                        </div>
                                        <label class="inline-flex items-center ">
                                            <input type="checkbox" class="form-checkbox h-5 w-5 text-blue-600 border" />
                                        </label>
                                ...
                                <div className='border h-[47px]  rounded-[4px] flex items-center bg-[#e8ebf0] px-4 '>
                                    <div className=' flex items-center justify-between w-full '>
                                        <div className='flex items-center gap-2.5'>
                                            <FiMenu size={24} className='text-[#d2d7df]' />
                                            <p className='text-[15.5px]  text-[#383c43] font_Roboto_Medium flex items-center gap-2'>Month  <IoChevronDownCircleOutline size={22} /></p>
                                        </div>
                                        <label class="inline-flex items-center ">
                                            <input type="checkbox" class="form-checkbox h-5 w-5 text-blue-600 border" />
                                        </label>
                                ...
                                <div className='border h-[47px]  rounded-[4px] flex items-center bg-[#e8ebf0] px-4 '>
                                    <div className=' flex items-center justify-between w-full '>
                                        <div className='flex items-center gap-2.5'>
                                            <FiMenu size={24} className='text-[#d2d7df]' />
                                            <p className='text-[15.5px]  text-[#383c43] font_Roboto_Medium flex items-center gap-2'>Page  <IoChevronDownCircleOutline size={22} /></p>
                                        </div>
                                        <label class="inline-flex items-center ">
                                            <input type="checkbox" class="form-checkbox h-5 w-5 text-blue-600 border" />
                                        </label>
                                ...
                                <div className='border h-[47px]  rounded-[4px] flex items-center bg-[#e8ebf0] px-4 '>
                                    <div className=' flex items-center justify-between w-full '>
                                        <div className='flex items-center gap-2.5'>
                                            <FiMenu size={24} className='text-[#d2d7df]' />
                                            <p className='text-[15.5px]  text-[#383c43] font_Roboto_Medium flex items-center gap-2'>Budget  <IoChevronDownCircleOutline size={22} /></p>
                                        </div>
                                        <label class="inline-flex items-center ">
                                            <input type="checkbox" class="form-checkbox h-5 w-5 text-blue-600 border" />
                                        </label>
