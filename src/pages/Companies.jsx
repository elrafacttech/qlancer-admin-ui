        ...
        <Homepage>
            ...
            <div className='px-[15px] pt-6  h-[100vh bg-[#f9f9f9] h-[100vh overflow-y-scroll overflow-hidden no-scrollbar pb-12'>
                <div className='w-full h-full shadow p-5 bg-[#ffffff] rounded-sm px-6 '>
                    <p className='text-[#434343] font_Roboto_Medium text-lg'>All Companies</p>
                                ...
                                <tbody>
                                    <tr className="border-b font_Roboto_Thin text-base h-20">
                                        ...
                                        <td className="px-6 py-4    font_Roboto_Regular   text-sm">
                                            <img className='w-12 h-12' src="https://quicklancer.bylancer.com/storage/products/952684562.jpg" alt="" />
                                            <p className='font_Roboto_Regular text-[#000000]'>Digital Marketing</p>
                                            <p className='font_Roboto_Light text-[#a0a0a0] pt-1'>0 jobs</p>
                                        </td>
                                        <td className=" py-4  ">
                                            <div className=' px-4  text-sm font_Roboto_Light flex items-center max-w-[450px]'>
                                                At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum de...
                                            </div>
                                        </td>
                                        <td className="px-6 py-4 text-sm font_Roboto_Light ">
                                            employer
                                        </td>
                                    ...
                                    <tr className="border-b font_Roboto_Thin text-base h-20">
                                        ...
                                        <td className="px-6 py-4    font_Roboto_Regular   text-sm">
                                            <img className='w-12 h-12' src="https://quicklancer.bylancer.com/storage/products/156501669.gif" alt="" />
                                            <p className='font_Roboto_Regular text-[#000000]'>Digital Marketing</p>
                                            <p className='font_Roboto_Light text-[#a0a0a0] pt-1'>0 jobs</p>
                                        </td>
                                        <td className=" py-4  ">
                                    ...
                                    <tr className="border-b font_Roboto_Thin text-base h-20">
                                        ...
                                        <td className="px-6 py-4    font_Roboto_Regular   text-sm">
                                            <img className='w-12 h-12' src="https://quicklancer.bylancer.com/storage/products/329007344.jpg" alt="" />
                                            <p className='font_Roboto_Regular text-[#000000]'>Digital Marketing</p>
                                            <p className='font_Roboto_Light text-[#a0a0a0] pt-1'>0 jobs</p>
                                        </td>
                                        <td className=" py-4  ">
                                    ...
                                    <tr className="border-b font_Roboto_Thin text-base h-20">
                                        ...
                                        <td className="px-6 py-4    font_Roboto_Regular   text-sm">
                                            <img className='w-12 h-12' src="https://quicklancer.bylancer.com/storage/products/879647146.jpg" alt="" />
                                            <p className='font_Roboto_Regular text-[#000000]'>Digital Marketing</p>
                                            <p className='font_Roboto_Light text-[#a0a0a0] pt-1'>0 jobs</p>
                                        </td>
                                        <td className=" py-4  ">
