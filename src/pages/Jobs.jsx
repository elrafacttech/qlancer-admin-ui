                ...
                <div>
                    <div className='w-full h-full shadow p-5 bg-[#ffffff] rounded-sm px-6 '>
                        <div className='flex justify-between items-center pt-1'>
                            ...
                            <div className='px-3 h-[37px] bg-[#5cb85c] rounded-[3px] flex justify-center items-center text-white font_Roboto_Medium'>Post job setting</div>
                        </div>
                        <section className='pt-7'>
                            ...
                            <table className="w-full text-left text-sm  rtl:text-right ">
                                    ...
                                    <div className='pt-3'>
                                        <p className='font_Roboto_Light'>No data available in table</p>
                                    </div>
                                ...
                                <div className='flex justify-between items-center pt-9'>
                                    <p className='text-[#7dc855 -mx-3 font_Roboto_Regular '>
                                        <span className='font_Roboto_Light'>Showing 0 to 0 of 0 entries</span>
                                    </p>
